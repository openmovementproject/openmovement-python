...
class TimeseriesCsvIterator:
    """
    (Note: this is a very slow approach, prefer numpy or pandas instead)
...
def main():
    ...
    tscsv = TimeseriesCsvIterator(test_file, {"time_zero": csv_time_from_filename(test_file), "global_scale": csv_scale_from_filename(test_file)})
    print(tscsv.header)
    for values in tscsv:
